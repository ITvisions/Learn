...
class HtImgShard(Base):
  ...
  id = Column(Integer, primary_key = True)
  uuid = Column(String(null), nullable = False, server_default = FetchedValue())
...
class HtLog(Base):
  ...
  uuid = Column(Integer, nullable = False, server_default = FetchedValue())
  data = Column(Text, nullable = False)
  create_time = Column(Integer, nullable = False)

class HtSuggest(Base):
  __tablename__ = 'ht_sugget'
