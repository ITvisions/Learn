...
class User(db.Model, UserMixin):
  ...
  id = db.Column(db.Integer, primary_key = True, autoincrement = True, commit='用户ID')
  username = db.Column(db.String(20), comment = '用户名')
  realname = db.Column(db.String(255), comment = '真实名字')
  ...
  create_id = db.Column(db.DateTime, default = datetime.datetime.now, comment = '创建时间')
