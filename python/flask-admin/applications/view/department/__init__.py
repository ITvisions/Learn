...
from applications.schemas import DeptOutChema
...
def data():
  ...
  power_data = curd.model_to_dicts(schema = DeptOutChema, data = dept)
  res = {
    'data': power_data
  }
  return jsonify(res)
...
def update():
  ...
  id = json.get('deptId')
  data = {
    'dept_naem': validate.xss_escape(json.get('deptName')),
